...
# If the user wishes to designate a web or docker repo, place the word WEB or DOCKER afterwards.
...
# To prevent errors when multiple repos are copied to the same folders, the www and dockerfiles f

#####################ENTER REQUESTED PUBLIC REPOS AFTER THIS COMMENT GROUP#####
...
#
# git_grab https://github.com/sidthakur/docker-simple-nginx-flask.git
#
...
git_grab https://github.com/twistedgitbox/simple_nginx.git DOCKER
#
git_grab https://github.com/pixelsign/html5-device-mockups.git WEB
